...
public class Producto {
     ...
     */
    public void cambiardarRutaImagen(String nuevaRutaImagen) {
    ...
    public int vender(int pCantidad) {
        ...
        if(this.cantidadBodega<pCantidad){
            cantidadVendida=this.cantidadBodega;
            this.cambiarCantidadBodega(0);
            this.cambiardarCantidadUnidadesVendidas(this.cantidadUnidadesVendidas+this.cantidadBodega);
            return cantidadVendida;
        }else{
            cantidadVendida = pCantidad;
            this.cambiarCantidadBodega(this.cantidadBodega-pCantidad);
            this.cambiardarCantidadUnidadesVendidas(this.cantidadUnidadesVendidas+pCantidad);
            return cantidadVendida;
        }
    }
    ...
    public boolean puedeAbastecer() {
        return this.cantidadMinima>this.cantidadBodega;
    }
}